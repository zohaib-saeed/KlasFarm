...
const Footer = () => {
  return (
    <div className="w-full max-w-[1440px] flex items-center justify-center">
      <div className="w-full px-2 xs:px-3 sm:px-4 md:px-5 lg:px-6  mx-2 xs:mx-3 sm:mx-4 md:mx-5 lg:mx-6 py-6  flex flex-col items-center justify-start bg-davyGrey">
