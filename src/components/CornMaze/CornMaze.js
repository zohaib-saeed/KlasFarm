        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] mxl:grid-cols-[0.8fr_1.2fr] gap-8 lg:gap-10 mxl:gap-12 ">
          ...
          <div className="w-full text-[18px] vsm:text-[20px] sxl:text-[22px] mxl:text-[25px] flex flex-col items-start justify-center  gap-3 mxl:gap-5 list-outside  list-disc text-black">
            <p>
              ...
              <span className="font-bold">Kukuričné bludiská</span>, a to v
              Dolnej Strehovej a v Lučenci. Zámerom bolo okrem tradičného
            ...
            <p>
              ...
              robiť nedá. Myšlienka vzniku kukuričných bludísk vznikla
              dávnejšie, reálne sme však s prípravou bludísk začali cca 3
              mesiace pred otvorením. Okrem samotnej výsadby, čo bola ta
              najľahšia vec, bolo za tým mnoho ďalšej práce. Do prípravy sme
              zapojili aj <span className="font-bold">študentov</span>, ktorý sa
              podieľali hlavne na programovaní a vývoji{" "}
              <span className="font-bold">webového</span> kvízu. Samotný
              výsledok je hlavne tímová práca všetkých kolegov a sme nesmierne
              radi, že sa nám to podarilo spustiť aj napriek problémom. Proti
              nám bolo hlavne počasie, lebo veľmi málo pršalo a kukurica
              nechcela rásť.
            </p>
          </div>
        </div>
        <div className="w-full grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] mxl:grid-cols-[0.8fr_1.2fr] gap-8 lg:gap-10 mxl:gap-12">
          ...
          <div className="  w-full text-[18px] vsm:text-[20px] sxl:text-[22px] mxl:text-[25px] flex flex-col items-start justify-center  gap-3 mxl:gap-5 list-outside  list-disc text-black">
            <p>
              ...
              2022, bolo priblíženie poľnohospodárstva prioritne deťom,
              teenagerom a samozrejme aj dospelým, prostredníctvom kvízu, aby si
              uvedomili, že mať potraviny na stole nie je až také samozrejme a
              je za tým kus práce všetkých ľudí, ktorí pracujú v tomto odvetví.
            </p>
            <p>
              ...
              sektor. V ďalších rokoch chceme v tejto myšlienke pokračovať a
              každý rok priniesť niečo nové a zaujímavé našim návštevníkom z
              oblasti poľnohospodárstva.
            </p>
            <p className="italic">Tešiť sa máte na čo aj tento rok!</p>
          </div>
          {/* Col 2  */}
          <div className="w-full flex items-center justify-end lg:justify-start">
            <div className="w-full  xs:max-w-[85%] sm:max-w-[75%] mdl:max-w-[60%] lg:max-w-none h-[370px] vsm:h-[400px] sm:h-[550px] mdl:h-[600px] flex items-center justify-center relative">
              <Image
