...
const Contacts = () => {
  return (
    <div className="w-full max-w-[1440px] pb-10 vsm:pb-12 md:pb-16 lg:pb-24 flex flex-col items-center justify-start gap-10 vsm:gap-12 md:gap-16 lg:gap-24 px-2 xs:px-3 sm:px-4 md:px-5 mdl:px-6">
